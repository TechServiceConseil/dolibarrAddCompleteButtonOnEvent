...
/**
 * \file    test/phpunit/AddCompleteButtonOnEventFunctionalTest.php
...
/**
 * Class AddCompleteButtonOnEventFunctionalTest
 *
 ...
 *
 * @package Testaddcompletebuttononevent
 */
class AddCompleteButtonOnEventFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modAddCompleteButtonOnEvent')->click();
		} else {
			// Disable the module
			$this->byHref('modAddCompleteButtonOnEvent')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/addcompletebuttononevent/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('addcompletebuttononevent/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/addcompletebuttononevent/admin/about.php');
		$this->authenticate();
		return $this->assertContains('addcompletebuttononevent/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('addcompletebuttononeventwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAddCompleteButtonOnEvent_AddCompleteButtonOnEventTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAddCompleteButtonOnEvent_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
